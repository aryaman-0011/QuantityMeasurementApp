...
public class QuantityMeasurementApp {
	...
	public static Length demonstrateLengthAddition(Length l1, Length l2) {
		...
		System.out.println(
				"Input: add(Quantity(" + l1 + "), " + "Quantity(" + l2 + "), " + " → Output: Quantity(" + result + ")");
		return result;
	}
	...
	public static Weight demonstrateWeightConversion(Weight w, WeightUnit targetUnit) {
		...
		System.out
				.println("Input: Quantity(" + w + ").convertTo(" + targetUnit + ") → Output: Quantity(" + result + ")");
	...
	public static Weight demonstrateWeightAddition(Weight w1, Weight w2, WeightUnit targetUnit) {
		...
		System.out.println("Input: Quantity(" + w1 + ").add(Quantity(" + w2 + "), " + targetUnit
	...
	public static void main(String[] args) {
		...
		demonstrateWeightEquality(new Weight(1.0, WeightUnit.KILOGRAM), new Weight(1000.0, WeightUnit.GRAM));

		demonstrateWeightEquality(new Weight(2.0, WeightUnit.POUND), new Weight(2.0, WeightUnit.POUND));

		demonstrateWeightEquality(new Weight(1.0, WeightUnit.KILOGRAM), new Weight(2.20462, WeightUnit.POUND));

		demonstrateWeightEquality(new Weight(500.0, WeightUnit.GRAM), new Weight(0.5, WeightUnit.KILOGRAM));

		demonstrateWeightEquality(new Weight(1.0, WeightUnit.POUND), new Weight(453.592, WeightUnit.GRAM));
		...
		demonstrateWeightConversion(new Weight(500.0, WeightUnit.GRAM), WeightUnit.POUND);
		...
		demonstrateWeightAddition(new Weight(1.0, WeightUnit.POUND), new Weight(453.592, WeightUnit.GRAM),
				WeightUnit.POUND);

		demonstrateWeightAddition(new Weight(2.0, WeightUnit.KILOGRAM), new Weight(4.0, WeightUnit.POUND),
				WeightUnit.KILOGRAM);
