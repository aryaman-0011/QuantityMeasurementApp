...
public class QuantityMeasurementAppTest {
	...
	void testConversion_SameUnit() {
		assertEquals(5.0, new Quantity<>(5.0, VolumeUnit.LITRE).convertTo(VolumeUnit.LITRE), EPSILON);
	}
	...
	void testConversion_RoundTrip() {
		assertEquals(1.5, new Quantity<>(1.5, VolumeUnit.LITRE).convertTo(VolumeUnit.LITRE), EPSILON);
	}
