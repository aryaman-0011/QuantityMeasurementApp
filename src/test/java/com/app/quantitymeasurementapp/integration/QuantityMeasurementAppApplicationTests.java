 ...
 * TestRestTemplate performs real HTTP calls — no mocking.
 * H2 in-memory DB is used (test profile).
 *
 * These tests verify that the entire stack (Controller → Service → JPA → H2)
 * works end-to-end as specified in UC17.
 */
...
class QuantityMeasurementAppApplicationTests {
    ...
    void testRestEndpointConvertQuantities() {
        ...
        ResponseEntity<QuantityMeasurementDTO> response = restTemplate.postForEntity(
            baseUrl() + "/convert", jsonEntity(input), QuantityMeasurementDTO.class);
    ...
    void testConvert_GallonToLitre() {
        QuantityInputDTO input = new QuantityInputDTO(
            new QuantityDTO(1.0, "GALLON", "VolumeUnit"),
    ...
    void testRestEndpointAddQuantities() {
        ...
        ResponseEntity<QuantityMeasurementDTO> response = restTemplate.postForEntity(
            baseUrl() + "/add", jsonEntity(input), QuantityMeasurementDTO.class);
    ...
    void testAdd_WeightUnits() {
        QuantityInputDTO input = new QuantityInputDTO(
            new QuantityDTO(2.0,   "KILOGRAM", "WeightUnit"),
    ...
    void testSubtract_LengthUnits() {
        ...
        ResponseEntity<QuantityMeasurementDTO> response = restTemplate.postForEntity(
            baseUrl() + "/subtract", jsonEntity(input), QuantityMeasurementDTO.class);
    ...
    void testDivide_LengthUnits() {
        ...
        ResponseEntity<QuantityMeasurementDTO> response = restTemplate.postForEntity(
            baseUrl() + "/divide", jsonEntity(input), QuantityMeasurementDTO.class);
    ...
    void testRestEndpointInvalidInput_Returns400() {
        ...
        ResponseEntity<String> response = restTemplate.postForEntity(
            baseUrl() + "/add", jsonEntity(input), String.class);
    ...
    void testDivideByZero_Returns500() {
        ...
        ResponseEntity<String> response = restTemplate.postForEntity(
            baseUrl() + "/divide", jsonEntity(input), String.class);
    ...
    void testGetHistoryByOperation_AfterAddCall() {
        ...
        QuantityInputDTO input = new QuantityInputDTO(
            new QuantityDTO(5.0, "FEET",   "LengthUnit"),
            new QuantityDTO(12.0,"INCHES", "LengthUnit")
        );
    ...
    void testH2DatabasePersistence() {
        QuantityMeasurementEntity entity = new QuantityMeasurementEntity(
            99.0, "FEET", "LengthUnit", 1.0, "INCHES", "LengthUnit",
            "add", 100.0, "FEET", "LengthUnit", "test", false, null
        );
    ...
    void testJPARepositoryFindByOperation() {
        QuantityMeasurementEntity entity = new QuantityMeasurementEntity(
            1.0, "FEET", "LengthUnit", 2.0, "FEET", "LengthUnit",
            "divide", 0.5, "RATIO", null, "0.5", false, null
        );
    ...
    void testJPARepositoryFindErrorTrue() {
        QuantityMeasurementEntity errEntity = new QuantityMeasurementEntity(
            ...
            "add", null, null, null, null, true, "incompatible types"
        );
    ...
    void testJPARepositoryCountByOperation() {
        ...
        QuantityMeasurementEntity entity = new QuantityMeasurementEntity(
            ...
            "compare", null, null, null, "true", false, null
        );
        repository.save(entity);
    ...
    void testIntegrationTest_MultipleOperations() {
        ...
        // compare
        restTemplate.postForEntity(baseUrl() + "/compare", jsonEntity(new QuantityInputDTO(
            new QuantityDTO(1.0, "FEET", "LengthUnit"),
            new QuantityDTO(12.0, "INCHES", "LengthUnit")
        )), QuantityMeasurementDTO.class);

        // add
        restTemplate.postForEntity(baseUrl() + "/add", jsonEntity(new QuantityInputDTO(
            new QuantityDTO(2.0, "KILOGRAM", "WeightUnit"),
            new QuantityDTO(500.0, "GRAM",   "WeightUnit")
        )), QuantityMeasurementDTO.class);

        // convert
        restTemplate.postForEntity(baseUrl() + "/convert", jsonEntity(new QuantityInputDTO(
            new QuantityDTO(100.0, "CELSIUS",    "TemperatureUnit"),
            new QuantityDTO(0.0,   "FAHRENHEIT", "TemperatureUnit")
        )), QuantityMeasurementDTO.class);
    ...
    void testBackwardCompatibility_YardEquality() {
        QuantityInputDTO input = new QuantityInputDTO(
            new QuantityDTO(1.0, "YARD", "LengthUnit"),
